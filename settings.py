...
#		'NAME': here('greenww.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'z@!#0=a(t$$4!2!6m8caks9n8=-u7j1cd^7u%io4w*vuo8(ck!'
...
ROOT_URLCONF = 'greenww.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'greenww.wsgi.application'
